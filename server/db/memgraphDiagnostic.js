...
const testQueries = [
  ...
  },
  {
    ...
    query: 'CALL mg.procedures() YIELD name WHERE name CONTAINS "vector" RETURN name',
    params: {}
  },
  {
    name: 'Vector Index Creation',
    query: `
      CREATE VECTOR INDEX test_vector_idx ON :TestNode(embedding)
      WITH CONFIG {
        "dimension": 768,
        "capacity": 1024,
        "metric": "cos",
  ...
  },
  {
    name: 'Vector Search',
    query: `
      CALL db.index.vector.queryNodes('test_vector_idx', $embedding, 5)
